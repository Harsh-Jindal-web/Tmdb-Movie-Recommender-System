  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <p className="text-gray-600 mb-6 max-w-2xl">
        Here's a collection of all the movies you have liked. Relive your
        favorites, explore their stories, and remember why you loved them!
      </p>
      ...
      {loading ? (
            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {/* Overview */}{" "}
                  {/* {movie.overview && ( <p className="text-gray-700 text-sm">{movie.overview}</p> )} */}
        ...
        <p className="text-gray-500">You haven't liked any movies yet.</p>
      )}
    </div>
  );
}
